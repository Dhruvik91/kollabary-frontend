...
export const Sidebar = ({
    ...
    const adminLinks = [
        ...
        { href: FRONTEND_ROUTES.DASHBOARD.ADMIN.FINANCE, icon: Coins, label: 'Finance' },
        { href: FRONTEND_ROUTES.DASHBOARD.ADMIN.ORDERS, icon: Coins, label: 'Orders' },
        { href: FRONTEND_ROUTES.DASHBOARD.ADMIN.USERS, icon: Coins, label: 'Users' },
    ];
                        ...
                        >
                            <div className="space-y-1">
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-medium text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors cursor-pointer"
                                >
                                    <LogOut size={18} />
                                    Log out
                                </button>
