...
export const MetricCard = ({
    ...
    return (
        <Card className={cn("rounded-[2rem] border-border/50 bg-card/50 backdrop-blur-sm overflow-hidden hover:shadow-xl hover:shadow-primary/5 transition-all duration-500 group", className)}>
