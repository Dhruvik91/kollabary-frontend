...
export const CollaborationErrorState = ({
    message = "There was an error loading your collaborations. Please check your connection and try again.",
    onRetry
}: CollaborationErrorStateProps) => {
    return (
        <div className="flex flex-col items-center justify-center p-8 sm:p-12 md:p-16 bg-red-50/30 dark:bg-red-500/5 border border-red-200/50 dark:border-red-500/10 rounded-[2rem] sm:rounded-[4rem] text-center space-y-6 sm:space-y-8 max-w-2xl mx-auto shadow-2xl shadow-red-500/5 backdrop-blur-sm transition-all duration-500">
            ...
            <div className="space-y-2 sm:space-y-3">
                <h3 className="text-2xl sm:text-3xl font-black tracking-tight text-zinc-900 dark:text-zinc-100">Service Interruption</h3>
